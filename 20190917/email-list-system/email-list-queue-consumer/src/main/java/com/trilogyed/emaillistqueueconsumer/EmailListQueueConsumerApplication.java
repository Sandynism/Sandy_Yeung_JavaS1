...
public class EmailListQueueConsumerApplication {
	...
	Queue queue() {
		...
		//The second parameter of the Queue constructor indicates whether the queue should be durable between restarts of the RabbitMQ broker.
	}
	...
	Binding binding(Queue queue, TopicExchange exchange) {
		...
		(where # is one or more characters) will be routed to our queue.
		We'll configure our producer to use this routing key.*/
	}
