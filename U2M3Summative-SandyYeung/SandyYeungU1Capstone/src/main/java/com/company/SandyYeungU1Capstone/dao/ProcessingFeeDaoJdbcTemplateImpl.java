...
public class ProcessingFeeDaoJdbcTemplateImpl implements ProcessingFeeDao {
    ...
    public ProcessingFee addProcessingFee(ProcessingFee processingFee) {
        jdbcTemplate.update(INSERT_PROCESSING_FEE_SQL, processingFee.getProductType(), processingFee.getFee());
        return processingFee;
    }
    ...
    public void updateProcessingFee(ProcessingFee processingFee) {
        jdbcTemplate.update(UPDATE_PROCESSING_FEE_SQL, processingFee.getProductType(), processingFee.getFee(), processingFee.getProductType());
    }
